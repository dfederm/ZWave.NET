<!--
  ...
  section: "4.67 Protection Command Class, version 1"
  pages: 387-389
-->
# 4.67 Protection Command Class, version 1

The Protection Command Class version 1 used to protect a device against unintentional control by e.g. a child.

## 4.67.1 Protection Set Command
...
Table 92, Protection Set::Protection State encoding
...
## 4.67.3 Protection Report Command
