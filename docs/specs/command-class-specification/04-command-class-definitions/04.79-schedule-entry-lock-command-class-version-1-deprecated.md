<!--
  ...
  section: "4.79 Schedule Entry Lock Command Class, version 1 [DEPRECATED]"
  pages: 469-479
-->
# 4.79 Schedule Entry Lock Command Class, version 1 [DEPRECATED]
...
Example: A homeowner is going away on vacation for two weeks. The homeowner could give the nd th neighbor a keypad code to the neighbor that would be active from April 2, 2008 to April 16 2008. The th code would be invalid after April 16 2008.

## 4.79.1 Schedule Entry Lock Enable Set Command
...
Table 113, Schedule Entry Lock Enable Set:: Enabled encoding
...
## 4.79.2 Schedule Entry Lock Enable All Set Command
...
## 4.79.3 Schedule Entry Lock Supported Get Command
...
## 4.79.4 Schedule Entry Lock Supported Report Command
...
## 4.79.5 Schedule Entry Lock Week Day Schedule Set Command
...
Table 114, Schedule Entry Lock Week Day Schedule Set::Set Action encoding
...
A value from 0 to 6 where 0 is Sunday. Start Hour (8 bits)
...
## 4.79.6 Schedule Entry Lock Week Days Schedule Get Command
...
## 4.79.7 Schedule Entry Lock Week Day Schedule Report Command
...
## 4.79.8 Schedule Entry Lock Year Day Schedule Set Command
...
Table 115, Schedule Entry Lock Year Day Schedule Set:: Set Action encoding
...
The User Identifier is used to recognize the user identity. A valid User Identifier MUST be a value starting from 1 to the maximum number of users supported by the device; refer to the User Code Command Class. If the user identifier is out of range, the command will be ignored Schedule Slot ID (8 bits)
...
## 4.79.9 Schedule Entry Lock Year Day Schedule Get Command
...
## 4.79.10 Schedule Entry Lock Year Day Schedule Report Command
