<!--
  ...
  section: "4.70 Rate Table Configuration Command Class, version 1"
  pages: 396-400
-->
# 4.70 Rate Table Configuration Command Class, version 1
...
The Rate Parameter Set ID indicates the requested parameter set. Rate Type (2 bits)
...
NOTE [: The actual charge is set using the Tariff Table Configuration Command Class, version 1.](04.89-tariff-table-configuration-command-class-version-1.md#489-tariff-table-configuration-command-class-version-1)
...
## 4.70.2 Rate Table Remove Command
