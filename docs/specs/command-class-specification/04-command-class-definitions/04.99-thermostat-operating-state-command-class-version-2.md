<!--
  ...
  section: "4.99 Thermostat Operating State Command Class, version 2"
  pages: 545-550
-->
# 4.99 Thermostat Operating State Command Class, version 2
...
## 4.99.1 Thermostat Operating State Get
...
## 4.99.2 Thermostat Operating State Report
...
[The thermostat operating state identifier MUST be set according to Table 132.](04.99-thermostat-operating-state-command-class-version-2.md#4992-thermostat-operating-state-report) Table 132, Thermostat Operating State Report version 2::Operating State encoding

|  | Operating |  | Description | Version |
| --- | --- | --- | --- | --- |
|  | State |  |  |  |
| 0x00 |  |  | Idle | 1 |
| 0x01 |  |  | Heating | 1 |
...
## 4.99.3 Thermostat Operating State Logging Supported Get
...
## 4.99.4 Thermostat Operating State Logging Supported Report
...
## 4.99.5 Thermostat Operating State Logging Get
...
## 4.99.6 Thermostat Operating State Logging Report
...
The number of hours (00:24) the thermostat has been in the indicated operating state since 12:00 am of the current day. Usage Today Minutes (8 bits)
