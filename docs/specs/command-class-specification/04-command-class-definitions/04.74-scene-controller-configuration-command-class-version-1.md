<!--
  ...
  section: "4.74 Scene Controller Configuration Command Class, version 1"
  pages: 418-421
-->
# 4.74 Scene Controller Configuration Command Class, version 1
...
## 4.74.1 Compatibility Considerations
...
## 4.74.2 Scene Controller Configuration Set Command
...
The value 0 MUST indicate that the receiving node MUST disable an associated scene for the specified Group ID. Dimming Duration (8 bits)
...
## 4.74.3 Scene Controller Configuration Get Command
...
## 4.74.4 Scene Controller Configuration Report Command
...
Value in the range 1..255 MUST indicate the actual Scene ID setting for the specified grouping identifier. The value 0 MUST indicate that the Group ID/Scene ID is disabled.
