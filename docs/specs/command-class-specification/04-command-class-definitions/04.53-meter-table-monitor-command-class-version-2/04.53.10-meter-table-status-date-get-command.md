<!--
  ...
  section: "4.53.10 Meter Table Status Date Get Command"
  pages: 306-308
-->
# 4.53.10 Meter Table Status Date Get Command
...
If the meter does not support a status event log history it must return the current state of the meter (see [section 4.53.11)](04.53.11-meter-table-status-report-command.md#45311-meter-table-status-report-command)
...
Specify the year in the usual Gregorian calendar. The first byte (Year 1) is the most significant byte. Start / Stop - Month (8 bits)
