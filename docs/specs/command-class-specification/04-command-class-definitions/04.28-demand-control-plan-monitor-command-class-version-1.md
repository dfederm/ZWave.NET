<!--
  ...
  section: "4.28 Demand Control Plan Monitor Command Class, version 1"
  pages: 153-157
-->
# 4.28 Demand Control Plan Monitor Command Class, version 1
...
## 4.28.2 DCP List Report Command
...
[Refer to DCP List Set command class (section 4.27.3) for detailed description of the fields.](04.27-demand-control-plan-configuration-command-class-version-1.md#4273-dcp-list-set-command)

## 4.28.3 DCP Event Status Get
...
## 4.28.4 DCP Event Status Report
...
Table 31, DCP Event Status Report::Event Status encoding
