<!--
  ...
  section: "4.31 Door Lock Logging Command Class, version 1"
  pages: 167-172
-->
# 4.31 Door Lock Logging Command Class, version 1
...
## 4.31.1 Door Lock Logging Records Supported Get Command
...
## 4.31.2 Door Lock Logging Records Supported Report Command
...
## 4.31.3 Door Lock Logging Record Get Command
...
## 4.31.4 Door Lock Logging Record Report Command
...
[This field MUST be encoded according to Table 40.](04.31-door-lock-logging-command-class-version-1.md#4314-door-lock-logging-record-report-command)
