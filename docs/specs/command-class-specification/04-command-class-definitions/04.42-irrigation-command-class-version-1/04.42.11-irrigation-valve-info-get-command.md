<!--
  ...
  section: "4.42.11 Irrigation Valve Info Get Command"
  pages: 232-233
-->
# 4.42.11 Irrigation Valve Info Get Command
...
The value 1 MUST indicate that the sending node requests the master valve information. The value 0 MUST indicate that the sending node requests information related to the zone valve corresponding to Valve ID field.
