<!--
  ...
  section: "4.9 Binary Sensor Command Class, version 1 [DEPRECATED]"
  pages: 73-74
-->
# 4.9 Binary Sensor Command Class, version 1 [DEPRECATED]
...
## 4.9.1 Binary Sensor Get Command
...
## 4.9.2 Binary Sensor Report Command
