<!--
  ...
  section: "4.94 Thermostat Fan Mode Command Class, Version 4"
  pages: 529-533
-->
# 4.94 Thermostat Fan Mode Command Class, Version 4
...
Table 129, Thermostat Fan Mode Set version 4::Fan Mode encoding

| Fan Mode (4 bits) |  | Description |  | CC |  |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  | Version |  |
...
## 4.94.2 Thermostat Fan Mode Get Command
...
## 4.94.3 Thermostat Fan Mode Report Command
...
## 4.94.4 Thermostat Fan Mode Supported Get Command
...
## 4.94.5 Thermostat Fan Mode Supported Report Command
...
[The Bit Mask fields describe the supported modes by the device (Refer to 4.94.1 Thermostat Fan Mode Set Command).](04.94-thermostat-fan-mode-command-class-version-4.md#4941-thermostat-fan-mode-set-command)

[](04.94-thermostat-fan-mode-command-class-version-4.md#4941-thermostat-fan-mode-set-command) Bit 0 in Bit Mask 1 field indicates support for mode = 0 (AUTO LOW)  Bit 1 in Bit Mask 1 field indicates support for mode = 1 (LOW)  Bit 2 in Bit Mask 1 field indicates support for mode = 2 (AUTO HIGH)  …
...
![figure p532](assets/img-2f5fb50cdf.png)
