...
[Refer to 4.1.3 Alarm Report Command](04.01-alarm-command-class-version-1-deprecated.md#413-alarm-report-command) Z-Wave Alarm Status (8 bits)
...
[Refer to 4.2.2 Alarm Set Command](04.02-alarm-command-class-version-2-deprecated.md#422-alarm-set-command)

Number of Event Parameters (8 bits)

Indicates the Number of Event Parameters fields used in bytes. Z-Wave Alarm Type (8 bits), Z-Wave Alarm Event (8 bits) and Event Parameters (N Byte)
