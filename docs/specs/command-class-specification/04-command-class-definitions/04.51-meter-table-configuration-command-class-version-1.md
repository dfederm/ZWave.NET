<!--
  ...
  section: "4.51 Meter Table Configuration Command Class, version 1"
  pages: 276-277
-->
# 4.51 Meter Table Configuration Command Class, version 1
...
## 4.51.1 Meter Table Point Adm Number Set Command
