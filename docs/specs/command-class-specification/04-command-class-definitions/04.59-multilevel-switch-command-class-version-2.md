<!--
  ...
  section: "4.59 Multilevel Switch Command Class, version 2"
  pages: 339-341
-->
# 4.59 Multilevel Switch Command Class, version 2
...
## 4.59.2 Multilevel Switch Set Command
...
## 4.59.3 Multilevel Switch Start Level Change Command
...
[For encoding of the duration value refer to section 4.59.2.](04.59-multilevel-switch-command-class-version-2.md#4592-multilevel-switch-set-command)
