<!--
  ...
  section: "4.8 Basic Window Covering Command Class, version 1 [OBSOLETED]"
  pages: 72-73
-->
# 4.8 Basic Window Covering Command Class, version 1 [OBSOLETED]
...
## 4.8.1 Basic Window Covering Start Level Change Command
...
## 4.8.2 Basic Window Covering Stop Level Change Command
