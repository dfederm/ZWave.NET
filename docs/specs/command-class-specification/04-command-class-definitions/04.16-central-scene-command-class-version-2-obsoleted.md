<!--
  ...
  section: "4.16 Central Scene Command Class, version 2 [OBSOLETED]"
  pages: 94-98
-->
# 4.16 Central Scene Command Class, version 2 [OBSOLETED]
...
## 4.16.2 Central Scene Supported Report Command
...
This field advertises the size of each “Supported Key Attributes” field measured in bytes. The value MUST be in the range 1..3.
...
This Bit Mask field advertises the attributes supported by the corresponding scene. The field MUST be [encoded according to Table 24.](04.16-central-scene-command-class-version-2-obsoleted.md#4162-central-scene-supported-report-command)

Table 24: Central Scene Supported Report::Supported Key Attributes
...
## 4.16.3 Central Scene Notification Command
...
This field advertises one or more events detected by the key. The field MUST be encoded according to [Table 25](04.16-central-scene-command-class-version-2-obsoleted.md#4163-central-scene-notification-command)
...
[Notification carrying these Key Attributes MUST comply with Figure 8.](04.16-central-scene-command-class-version-2-obsoleted.md#4163-central-scene-notification-command)

![Figure 8, Central Scene button press decoding and timer management](assets/img-73381c079f.png)
