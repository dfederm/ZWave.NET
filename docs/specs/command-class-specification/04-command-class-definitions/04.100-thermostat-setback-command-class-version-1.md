<!--
  ...
  section: "4.100 Thermostat Setback Command Class, version 1"
  pages: 550-553
-->
# 4.100 Thermostat Setback Command Class, version 1

The Thermostat Setback Command Class is used to change the current state of a non-schedule setback thermostat.

## 4.100.1 Thermostat Setback Set Command
...
[The setback type field MUST comply with Table 133](04.100-thermostat-setback-command-class-version-1.md#41001-thermostat-setback-set-command)

Table 133, Thermostat Setback Set::Setback Type encoding
...
[The Setback State MUST comply with Table 134](04.100-thermostat-setback-command-class-version-1.md#41001-thermostat-setback-set-command) Table 134, Thermostat Setback Set::Setback State encoding
...
Note: The implementation of Energy Saving Mode is manufacturer specific, and MUST be documented in the User’s Manual. If the device is set to an unreachable state, the device SHOULD assume the closest possible state.

## 4.100.2 Thermostat Setback Get Command
...
## 4.100.3 Thermostat Setback Report Command
