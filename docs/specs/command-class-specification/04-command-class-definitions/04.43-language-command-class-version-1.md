<!--
  ...
  section: "4.43 Language Command Class, version 1"
  pages: 245-247
-->
# 4.43 Language Command Class, version 1

The Language Command Class is used to specify the language settings on a device.

## 4.43.1 Language Set Command
...
## 4.43.3 Language Report Command
...
[For fields’ description, refer to 4.43.1 Language Set Command.](04.43-language-command-class-version-1.md#4431-language-set-command)
