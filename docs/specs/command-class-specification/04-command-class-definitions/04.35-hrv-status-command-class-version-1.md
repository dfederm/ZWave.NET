<!--
  ...
  section: "4.35 HRV Status Command Class, version 1"
  pages: 186-189
-->
# 4.35 HRV Status Command Class, version 1
...
## 4.35.2 HRV Status Report Command
...
[The status parameter used to indicate which status parameter that is reported. Refer to 4.35.1 HRV Status Get for possible values.](04.35-hrv-status-command-class-version-1.md#4351-hrv-status-get-command)
...
## 4.35.3 HRV Status Supported Get Command
...
## 4.35.4 HRV Status Supported Report Command
