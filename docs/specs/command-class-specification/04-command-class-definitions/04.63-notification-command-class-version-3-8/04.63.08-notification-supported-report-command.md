<!--
  ...
  section: "4.63.8 Notification Supported Report Command"
  pages: 371-372
-->
# 4.63.8 Notification Supported Report Command
...
 Bit 0 in Bit Mask 1 is not allocated to any Notification Type and MUST be set to zero.  Bit 1 in Bit Mask 1 indicates if Notification Type = Smoke Alarm (0x01) is supported.  Bit 2 in Bit Mask 1 indicates if Notification Type = CO Alarm (0x02) is supported.  Bit 3 in Bit Mask 1 indicates if Notification Type = CO Alarm (0x03) is supported 2  …

[For Notification Types, refer to [18].](../04.107-window-covering-command-class-version-1.md#410710-window-covering-stop-level-change-command)
