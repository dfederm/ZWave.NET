<!--
  ...
  section: "4.2 Anti-theft Command Class, version 1 [OBSOLETED]"
  pages: 51-52
-->
# 4.2 Anti-theft Command Class, version 1 [OBSOLETED]

THIS COMMAND CLASS VERSION HAS BEEN OBSOLETED

New implementations MUST use the Anti-theft Command Class Version 2.
