<!--
  ...
  section: "4.13 Binary Toggle Switch Command Class, version 1 [OBSOLETED]"
  pages: 81-83
-->
# 4.13 Binary Toggle Switch Command Class, version 1 [OBSOLETED]
...
## 4.13.1 Binary Toggle Switch Set Command
...
## 4.13.2 Binary Toggle Switch Get Command
...
## 4.13.3 Binary Toggle Switch Report Command
