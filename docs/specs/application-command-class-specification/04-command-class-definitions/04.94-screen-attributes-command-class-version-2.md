<!--
  ...
  section: "4.94 Screen Attributes Command Class, version 2"
  pages: 546-547
-->
# 4.94 Screen Attributes Command Class, version 2
...
## 4.94.1 Screen Attributes Report Command
...
This field MUST be set to 0 by a sending node and MUST be ignored by a receiving node. Escape Sequence(1 bit)
...
[This field MUST be encoded according to Table 124](04.93-screen-attributes-command-class-version-1.md#4932-screen-attributes-report-command)
