<!--
  ...
  section: "4.71 Multilevel Switch Command Class, version 3"
  pages: 409-414
-->
...
[The Primary Switch Type MUST comply with Table 83.](04.71-multilevel-switch-command-class-version-3.md#4713-multilevel-switch-supported-report-command) A supporting device MUST implement the Primary Switch type. The Primary Switch Type SHOULD be 0x02 (Up/Down). The Primary Switch Type MUST NOT be 0x00 (Undefined).
...
The Secondary Switch Type field MUST represent the secondary device functionality. The Secondary [Switch Type MUST comply with Table 83](04.71-multilevel-switch-command-class-version-3.md#4713-multilevel-switch-supported-report-command)
...
[This field MUST be encoded according to Table 84.](04.71-multilevel-switch-command-class-version-3.md#4714-multilevel-switch-start-level-change-command)
...
A receiving device SHOULD respect the start level if the Ignore Start Level bit is 0. A receiving device MUST ignore the start level if the Ignore Start Level bit is 1. Secondary Switch Inc/Dec (2 bits)
...
[This field MUST be encoded according to Table 85.](04.71-multilevel-switch-command-class-version-3.md#4714-multilevel-switch-start-level-change-command)
...
This field is unchanged from version 2. Secondary Switch Step Size (8 bits)
...
[An implementation MUST interpret the combined Inc/Dec and Step Size fields as outlined in Table 86.](04.71-multilevel-switch-command-class-version-3.md#4714-multilevel-switch-start-level-change-command)
