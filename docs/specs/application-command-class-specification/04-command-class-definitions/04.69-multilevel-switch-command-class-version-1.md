<!--
  ...
  section: "4.69 Multilevel Switch Command Class, version 1"
  pages: 403-407
-->
# 4.69 Multilevel Switch Command Class, version 1
...
## 4.69.1 Multilevel Switch Set Command
...
[The encoding of the Value field MUST be according to Table 81.](04.69-multilevel-switch-command-class-version-1.md#4691-multilevel-switch-set-command)
...
## 4.69.3 Multilevel Switch Report Command
...
## 4.69.5 Multilevel Switch Stop Level Change Command
