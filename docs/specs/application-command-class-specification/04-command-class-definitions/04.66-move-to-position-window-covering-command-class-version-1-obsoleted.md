<!--
  ...
  section: "4.66 Move To Position Window Covering Command Class, version 1 [OBSOLETED]"
  pages: 389-391
-->
...
## 4.66.1 Move To Position Set Command
...
[The encoding of the Value field MUST be according to Table 77.](04.66-move-to-position-window-covering-command-class-version-1-obsoleted.md#4661-move-to-position-set-command)
...
## 4.66.3 Move To Position Report Command
