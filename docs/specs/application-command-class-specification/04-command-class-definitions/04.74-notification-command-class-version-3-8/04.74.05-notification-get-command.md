<!--
  ...
  section: "4.74.5 Notification Get Command"
  pages: 430-432
-->
...
[The receiving node behavior SHOULD comply with Table 87 and Table 88.](04.74.02-compatibility-considerations.md#47427-version-4-deprecated) CC:0071.03.04.12.001

Notification Type (8 bits)

[This field is used to specify a Notification Type. Assigned values are defined in [18].](../04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
A Notification Type value indicates to the receiving node that it SHOULD retrieve the next Notification in its Notification queue matching the specified Notification Type value. Notification Event / State (8 bits)

This field is used to optionally specify a Notification Event/State within the Notification Type. Assigned [values are defined in [18]. This field allows receiving nodes to differentiate between V2 Alarm Get](../04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command) Command and V3 or newer Notification Get Command.
