<!--
  ...
  section: "4.14 Basic Command Class, version 2"
  pages: 111-113
-->
...
[The compatibility considerations from version 1 also apply to this version. Refer to 4.13.1.](04.13-basic-command-class-version-1.md#4131-compatibility-considerations)
...
The advertised values may vary depending on the device class implemented by the supporting device. A [controlling device MUST interpret the value according to Table 21.](04.13-basic-command-class-version-1.md#4134-basic-report-command) [For details on the mapping of values, refer [10] and [22].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
If the device is in a motion controlled transition, the Target Value field MUST advertise the min or max [value (depending on the direction) according to the command class mappings defined in [10] and [22].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
