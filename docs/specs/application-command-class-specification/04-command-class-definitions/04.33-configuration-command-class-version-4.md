<!--
  ...
  section: "4.33 Configuration Command Class, version 4"
  pages: 183-189
-->
...
 [Configuration Set Command](04.33-configuration-command-class-version-4.md#4332-configuration-set-command)  [Configuration Bulk Set Command](04.33-configuration-command-class-version-4.md#4333-configuration-bulk-set-command)  [Configuration Properties Report Command](04.33-configuration-command-class-version-4.md#4334-configuration-properties-report-command)

The following new command is introduced:

 [Configuration Default Reset Command](04.33-configuration-command-class-version-4.md#4335-configuration-default-reset-command)
...
[Refer to 4.32.1.2.](04.32-configuration-command-class-version-3.md#43212-configuration-properties-report)

The recommendation given in version 3 does not apply to version 4 supporting nodes as new fields are [appended at the end of the Configuration Properties Report Command in version 4.](04.32-configuration-command-class-version-3.md#4328-configuration-properties-report-command)
...
 A Z-Wave or Z-Wave Plus node MUST NOT advertise the new and/or Multi Channel End Point capabilities before being excluded from its current network.  A Z-Wave Plus version 2 node MUST advertise its new capabilities immediately.
...
 It is manually reset to factory default  [It receives a Configuration Default Reset Command.](04.33-configuration-command-class-version-4.md#4335-configuration-default-reset-command)
...
## 4.33.2 Configuration Set Command
...
The value 1 MUST indicate that default factory settings must be restored for the specified Parameter Number. In this case, the Configuration value field MUST be ignored and any other parameters MUST CC:0070.04.04.11.003 NOT be reset by a receiving node.
...
## 4.33.3 Configuration Bulk Set Command
...
| Defaul t | Hand- shake | Reserved |  |  | Size |  |  |
...
## 4.33.4 Configuration Properties Report Command
...
The value 0 MUST indicate that the advertised parameter is not read-only. Altering capabilities (1 bit)
...
[Refer to 4.33.1.4 “Altering capabilities” flag.](04.33-configuration-command-class-version-4.md#43314-altering-capabilities-flag)
...
## 4.33.5 Configuration Default Reset Command
