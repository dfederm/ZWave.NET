<!--
  ...
  section: "4.101 Tariff Table Configuration Command Class, version 1"
  pages: 571-575
-->
...
The Standing Charge value MUST be encoded as a 32-bit signed integer. The first byte MUST be the [most significant byte. Table 10, Signed field encoding (two’s complement representation) shows signed](../03-command-class-overview/03.07-common-fields-and-encoding.md#375-signed-encoding) decimal values together with their hexadecimal equivalents.
...
## 4.101.2 Tariff Table Set Command
...
## 4.101.3 Tariff Table Remove Command
