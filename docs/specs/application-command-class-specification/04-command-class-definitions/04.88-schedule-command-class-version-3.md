<!--
  ...
  section: "4.88 Schedule Command Class, version 3"
  pages: 510-520
-->
...
This command MUST enable the schedule if a new schedule is created. This command MUST NOT change the enabled/disabled state of existing schedules.
...
Fields not described below remain unchanged from version 2. Reserved

This field MUST be set to 0 by a sending node and MUST be ignored by a receiving node.

### 4.88.4.1 Recurrence fields
...
[This field MUST comply with Table 115.](04.88-schedule-command-class-version-3.md#48841-recurrence-fields)
...
[This field MUST be encoded according to Table 116 and MUST be interpreted together with the](04.88-schedule-command-class-version-3.md#48841-recurrence-fields) Recurrence Mode field.
...
When a schedule starts due to its start time options, it MUST restart the current recurrence timer. It means that a schedule MUST start every time the start time condition is met and the recurrence offset MUST trigger the schedule to restart based on the last time it started. For example, a schedule set to start on the 1 st of each month with a 2 day recurrence offset MUST start on the 1, 3, 5 …, 27, 29, 31 and will start again the next month on the 1, 3, etc. st rd th th th st st rd
...
The value 1 MUST indicate that the start time fields MUST be interpreted as the time left before the [schedule starts. In this case, the start time fields MUST be set and interpreted as indicated in 4.88.3.1](04.88-schedule-command-class-version-3.md#48831-start-time-option-start-from-now) and the schedule MUST NOT be activated again at a later time unless receiving another Schedule Set Command.
...
## 4.88.6 Schedule Report Command
...
[If this field carries the Active_ID value, this field MUST be encoded according to Table 113.](04.86-schedule-command-class-version-1/04.86.11-schedule-state-report-command.md#48611-schedule-state-report-command) [If this field carries the Recurrence Offset, this field MUST be encoded according to Table 116 and MUST](04.88-schedule-command-class-version-3.md#48841-recurrence-fields) be interpreted together with the Recurrence Mode field.
...
[This field MUST comply with Table 115 if the AID_RO_CTL field is set to 1.](04.88-schedule-command-class-version-3.md#48841-recurrence-fields)
