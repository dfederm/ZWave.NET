<!--
  ...
  section: "4.25 Climate Control Schedule Command Class, version 1 [DEPRECATED]"
  pages: 140-147
-->
...
[This field MUST be encoded according to Table 28.](04.25-climate-control-schedule-command-class-version-1-deprecated.md#4251-schedule-set-command)
...
[Schedule State uses the Schedule State type format, see section 4.25. If Schedule State has the value of](04.25-climate-control-schedule-command-class-version-1-deprecated.md#425-climate-control-schedule-command-class-version-1-deprecated) “Unused”, the Hour and Minute field MUST be ignored. Once a Schedule State of “Unused” is encountered, the parsing of switchpoints must stop.
...
[For fields’ description, refer to 4.25.1 Schedule Set Command](04.25-climate-control-schedule-command-class-version-1-deprecated.md#4251-schedule-set-command)

## 4.25.3 Schedule Report Command
...
## 4.25.5 Schedule Changed Report Command
...
[This field MUST be encoded according to Table 29.](04.25-climate-control-schedule-command-class-version-1-deprecated.md#4256-schedule-override-set-command)
...
[The Override State uses the Schedule State type format, see section 4.25](04.25-climate-control-schedule-command-class-version-1-deprecated.md#425-climate-control-schedule-command-class-version-1-deprecated)
...
## 4.25.8 Schedule Override Report Command
...
Both temporary and permanent overrides MAY be cancelled in the device, which receives the SCHEDULE_OVERRIDE_SET. This cancellation MUST be notified in an unsolicited [SCHEDULE_OVERRIDE_REPORT as shown on figure in section 4.25.6](04.25-climate-control-schedule-command-class-version-1-deprecated.md#4256-schedule-override-set-command)
