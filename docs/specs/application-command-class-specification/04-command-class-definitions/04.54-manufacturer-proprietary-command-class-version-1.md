<!--
  ...
  section: "4.54 Manufacturer Proprietary Command Class, version 1"
  pages: 338-339
-->
...
The Manufacturer ID is a unique ID identifying the manufacturer of the device. Manufacturer identifiers [can be found in [12].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
