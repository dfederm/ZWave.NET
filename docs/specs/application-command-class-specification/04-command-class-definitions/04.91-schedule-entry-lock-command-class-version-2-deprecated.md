<!--
  ...
  section: "4.91 Schedule Entry Lock Command Class, version 2 [DEPRECATED]"
  pages: 538-540
-->
...
Specify the number of hours that the originating time zone deviates from UTC. Refer to the DST field regarding daylight savings handling. Minute TZO (7 bits)
...
## 4.91.3 Schedule Entry Lock Time Offset Report Command
