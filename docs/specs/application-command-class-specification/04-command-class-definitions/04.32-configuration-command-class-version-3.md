<!--
  ...
  section: "4.32 Configuration Command Class, version 3"
  pages: 174-183
-->
...
 [Configuration Name Get Command](04.32-configuration-command-class-version-3.md#4323-configuration-name-get-command)  [Configuration Name Report Command](04.32-configuration-command-class-version-3.md#4324-configuration-name-report-command)  [Configuration Info Get Command](04.32-configuration-command-class-version-3.md#4325-configuration-info-get-command)  [Configuration Info Report Command](04.32-configuration-command-class-version-3.md#4326-configuration-info-report-command)  [Configuration Properties Get Command](04.32-configuration-command-class-version-3.md#4327-configuration-properties-get-command)  [Configuration Properties Report Command](04.32-configuration-command-class-version-3.md#4328-configuration-properties-report-command)
...
[Refer to 4.30.1.1.](04.30-configuration-command-class-version-1.md#43011-default-flag)

### 4.32.1.2 Configuration Properties Report

Earlier text revisions of the Configuration Command Class, version 3 did not explicitly specify that the CC:0070.03.00.21.003 “Min Value”, “Max Value” and “Default Value” fields MUST be omitted if the advertised size is 0 in the [Configuration Properties Report Command.](04.32-configuration-command-class-version-3.md#4328-configuration-properties-report-command)
...
## 4.32.4 Configuration Name Report Command
...
## 4.32.6 Configuration Info Report Command
...
It is RECOMMENDED that the information stored in a supporting device is in English. It is RECOMMENDED that the last line of the information field presents an Internet URL which points to updated information for the actual configuration parameter as well as other language variants.
...
If a non-existing parameter is specified in this command, a receiving node MUST advertise zero values in the Format and Size fields. The Next Parameter Number field MUST advertise the next available CC:0070.03.0E.11.003 configuration parameter.
...
## 4.32.8 Configuration Properties Report Command
...
This field is used to advertise the format of the parameter. [The value of this field MUST comply with Table 33.](04.32-configuration-command-class-version-3.md#4328-configuration-properties-report-command)
...
CC:0070.03.0F.11.006 All other values are reserved and MUST NOT be used by a sending node. Reserved values MUST be ignored by a receiving node.
...
If the parameter format is “Enumerated”, the parameter MUST be treated as an unsigned integer. CC:0070.03.0F.12.001 [A graphical configuration tool SHOULD present this parameter as a series of radio buttons [11].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)

If the parameter format is “Bit field” the parameter MUST be treated as a bit field where each individual bit can be set or reset. [A graphical configuration tool SHOULD present this parameter as a series of checkboxes [11].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
[The value of this field MUST comply with Table 34.](04.32-configuration-command-class-version-3.md#4328-configuration-properties-report-command)
...
All other values are reserved and MUST NOT be used by a sending node. Reserved values MUST be ignored by a receiving node. Min Value (N bytes)
