<!--
  ...
  section: "4.68 Multilevel Sensor Command Class, Version 5-11"
  pages: 393-403
-->
# 4.68 Multilevel Sensor Command Class, Version 5-11
...
 New Sensor Types and Scale Values for Water Flow and Water Pressure  New Sensor Types and Scale Values for RF Signal Strength Version 10 of this command class is extended with the following functionality:
...
 New Sensor Types and Scale Values.  [Moved the list of assigned Sensor Types and Scale Values to an external registry [17].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)  Deprecated the “General Purpose” Sensor Type

### 4.68.1.1 Unknown Multilevel Sensor Types and Scales

A controlling node SHOULD implement the capability to update its Multilevel sensor types and scales [list, so that new Types and Scales added in [17] are not presented as unknown. If a controlling node](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command) receives an unknown Type or Scale, it SHOULD allow the user to assign a free-text description to that Type or Scale.
...
[The list of Sensor Types is defined in [17].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
It is only necessary to send the Bit Mask fields from 1 and up to the Bit Mask N indicating the last CC:0031.05.02.11.003 supported Sensor Type. The number of Bit Mask fields transmitted MUST be determined from the length field in the frame.
...
## 4.68.5 Multilevel Sensor Supported Scale Report Command
...
[The list of scales for a given sensor type is defined in [17].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
## 4.68.7 Multilevel Sensor Report Command
...
[This field MUST be set to a value defined in [17]. Values not defined in [17] are reserved and MUST NOT](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command) be used.

A node MUST support as a minimum the highest Multilevel Sensor Command Class version associated with the Scale and Type it supports. The minimum required version for each Scale and Type is specified [in [17].](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command)
...
This field MUST be set to 1, 2 or 4. Sensor Value (N bytes)

This field is used to advertise the value of the actual sensor reading.

The length of this field MUST be according to the Size field value. The first byte MUST be the most significant byte. [This field MUST be encoded using signed representation and comply with Table 10, Signed field encoding (two’s complement representation).](../03-command-class-overview/03.07-common-fields-and-encoding.md#375-signed-encoding)
...
A controlling node SHOULD implement the capability to update its list of Sensor Type and Scales, so that [new Sensor Types and Scales added in [17] are not presented as unknown. If a controlling node receives](04.117-window-covering-command-class-version-1.md#411710-window-covering-stop-level-change-command) an unknown Sensor Type or Scale, it SHOULD allow the user to assign a free-text description to the sensor reading.
...
![Figure 13, 3D reference coordinate system](assets/img-0d643251a7.png)
...
Depending on the number of axes supported by a given device, changes in the physical orientation are [mapped to one, two or three axes as outlined in Table 79.](04.68-multilevel-sensor-command-class-version-5-11.md#46871-detailed-description-sensor-types-for-movement-and-rotation)
