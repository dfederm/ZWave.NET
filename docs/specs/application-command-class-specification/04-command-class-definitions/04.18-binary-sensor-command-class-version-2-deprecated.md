<!--
  ...
  section: "4.18 Binary Sensor Command Class, version 2 [DEPRECATED]"
  pages: 118-121
-->
...
## 4.18.2 Binary Sensor Report Command
...
Sensor Value (8 bits) Sensor Value = 0x00 indicates that the sensor is idle and 0xFF indicates that the sensor has detected an event.
