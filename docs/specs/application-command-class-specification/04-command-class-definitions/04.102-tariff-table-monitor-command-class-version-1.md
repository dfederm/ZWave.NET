<!--
  ...
  section: "4.102 Tariff Table Monitor Command Class, version 1"
  pages: 575-582
-->
...
## 4.102.2 Tariff Table Supplier Report Command
...
[Refer to description of fields under the Tariff Table Supplier Set Command (section 4.101.1)](04.101-tariff-table-configuration-command-class-version-1.md#41011-tariff-table-supplier-set-command)
...
## 4.102.4 Tariff Table Report Command
...
[Refer to description of fields under the Tariff Table Set Command (section 4.101.2)](04.101-tariff-table-configuration-command-class-version-1.md#41012-tariff-table-set-command)
...
Start Day (8 bits) Specify the day of the month between 01 and 31.
...
The Rate Parameter Set ID indicates the requested parameter set. Rate Parameter Set ID equal to 0xFF returns accumulated cost. Reserved
...
[ISO 4217 defines the currency code. Examples are given in Table 134.](04.101-tariff-table-configuration-command-class-version-1.md#41011-tariff-table-supplier-set-command)
