<!--
  ...
  section: "4.115 User Code Command Class, version 1"
  pages: 622-626
-->
...
This Command Class can be used in conjunction with Schedule Entry Lock Command Class in order to schedule access for users. A node receiving a User Code Get Command MUST advertise what User Code is set in the User Code Report Command.
...
The value 0 MUST indicate that the receiving node MUST set the User Code and User Status for all CC:0063.01.01.12.001 supported User Identifiers. The value 0 SHOULD be used only with User ID Status set to 0x00.
...
[The User ID Status field indicates the status of the User Identifier. This field MUST comply with Table 145.](04.115-user-code-command-class-version-1.md#41152-user-code-set-command)

The User ID Status 0xFE SHOULD NOT be used in this command. Table 145, User Code Set::User ID Status encoding
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Command Class = COMMAND CLASS USER CODE (0x63) _ _ _ |  |  |  |  |  |  |  |
| Command = USER CODE GET (0x02) _ _ |  |  |  |  |  |  |  |
| User Identifier |  |  |  |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Command Class = COMMAND CLASS USER CODE (0x63) _ _ _ |  |  |  |  |  |  |  |
| Command = USER CODE REPORT (0x03) _ _ |  |  |  |  |  |  |  |
| User Identifier |  |  |  |  |  |  |  |
| User ID Status |  |  |  |  |  |  |  |
| User Code 1 |  |  |  |  |  |  |  |
| ... |  |  |  |  |  |  |  |
...
[For fields’ description, refer to 4.115.2 User Code Set Command.](04.115-user-code-command-class-version-1.md#41152-user-code-set-command)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Command Class = COMMAND CLASS USER CODE (0x63) _ _ _ |  |  |  |  |  |  |  |
| Command = USERS NUMBER GET (0x04) _ _ |  |  |  |  |  |  |  |

## 4.115.6 Users Number Report Command
