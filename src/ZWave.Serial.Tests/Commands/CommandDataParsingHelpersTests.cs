...
public class CommandDataParsingHelpersTests
{
    ...
    public void ParseNodeBitmask_AllZeros_ReturnsEmpty()
    {
        ...
        IReadOnlySet<ushort> result = CommandDataParsingHelpers.ParseNodeBitmask(bitMask, baseNodeId: 1);
    ...
    public void ParseNodeBitmask_LongRangeNodes_BaseNodeId256()
    {
        ...
        IReadOnlySet<ushort> result = CommandDataParsingHelpers.ParseNodeBitmask(bitMask, baseNodeId: 256);
    ...
    public void ParseNodeBitmask_LongRangeNodes_NonZeroBitmaskOffset()
    {
        ...
        IReadOnlySet<ushort> result = CommandDataParsingHelpers.ParseNodeBitmask(bitMask, baseNodeId: 1280);
